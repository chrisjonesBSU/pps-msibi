...
def get_parameters(ordered_dict=OrderedDict()):
    ...
    parameters["T_scale"] = [1, 0.70, 0.60, 0.50]
    ...
    parameters["states"] = [
        [
            ...
            {"name": "LowDen",
             "alpha": 0.6,
             "n_frames": 50,
             "target_project": "/home/erjank_project/PPS-MSIBI/pps-msibi/training-runs/low-density-states",
             "target_job_id": "5f74799263ad8fdad51aa658a4ad2f38",
             "cg_file_name": "target_1monomer_per_bead.gsd",
             },
        ],
    ]
