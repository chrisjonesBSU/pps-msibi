...
def run_validate_lattice(job):
    ...
    with job:
        ...
        print("Running initial relaxation step.")
        sim.run_NVT(n_steps=5e6, kT=1.0, tau_kt=tau_kT)

        print("Annealing to final temperature...")
        ...
        print("Running NVT at final temperature.")
